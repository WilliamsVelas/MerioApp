...
class DeleteClient @Inject constructor(private val repositoryImp: RepositoryImp){
    suspend operator fun invoke(client: Client) = repositoryImp.deleteClient(client)
}